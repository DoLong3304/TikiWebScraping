...
class PipelineRunner:
    ...
    def run_transform(self, plan: Optional[TransformPlan] = None) -> Dict[str, int]:
        ...
        return {
            ...
            "fact_product_daily_rows": result.fact_product_daily_rows,
            "fact_seller_daily_rows": result.fact_seller_daily_rows,
    ...
    def build_transform_plan(
        ...
        *,
        ...
        fact_product_daily: bool,
        fact_seller_daily: bool,
        review_clean: bool,
        review_daily: bool,
        review_summary: bool,
    ) -> TransformPlan:
